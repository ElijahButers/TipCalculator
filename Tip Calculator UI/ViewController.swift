...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ViewController.keyboardDidChange(notification:)), name: Notification.Name.UIKeyboardWillHide, object: nil)
